...
describe Item, type: :model do
	...
	describe 'class methods' do
		...
		it '.top_5' do
			...
			order_item_1 = item_1.order_items.create!(quantity: 10, price: 5.00, fulfilled: true)
			order_item_2 = item_2.order_items.create!(quantity: 9, price: 5.00, fulfilled: true)
			order_item_3 = item_3.order_items.create!(quantity: 8, price: 5.00, fulfilled: true)
			order_item_4 = item_4.order_items.create!(quantity: 7, price: 5.00, fulfilled: true)
			order_item_5 = item_5.order_items.create!(quantity: 6, price: 5.00, fulfilled: true)
			order_item_6 = item_6.order_items.create!(quantity: 10, price: 5.00, fulfilled: true)
		...
		it '.bottom_5' do
			...
			order_item_4 = item_4.order_items.create!(quantity: 7, price: 5.00, fulfilled: true)
			order_item_5 = item_5.order_items.create!(quantity: 6, price: 5.00, fulfilled: true)
			order_item_6 = item_6.order_items.create!(quantity: 10, price: 5.00, fulfilled: false)
