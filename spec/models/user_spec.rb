...
RSpec.describe User, type: :model do
  ...
  describe 'roles' do
    ...
    it "can be created as an admin" do
      admin_1 = User.create!(email: "Bob@bob.bob", password_digest: "password", role: 2, active: true, name: "Bob Bob", address: "123 Shady Lane", city: "Boulda", state: "CO", zip: "80303")
    ...
    it "can be created as a default user" do
      user_1 = User.create!(email: "Bob@bob.bob", password_digest: "password", role: 0, active: true, name: "Bob Bob", address: "123 Shady Lane", city: "Boulda", state: "CO", zip: "80303")
